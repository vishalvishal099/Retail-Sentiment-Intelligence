...
\textbf{0.7642} overall; on the small long-post bucket
($\ge 512$~tokens, $n{=}7$, all negative-class) the baseline classifies
5/7 correctly and the fine-tuned model \textbf{7/7}, showing the
truncation ceiling that limited the baseline is removed.  On a 32-image benchmark the multi-pass vision
