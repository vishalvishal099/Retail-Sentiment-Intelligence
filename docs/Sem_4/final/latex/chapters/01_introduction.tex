...
\textbf{0.7642} overall, and recovering all long posts ($\ge 512$~tokens,
$n{=}7$, all negative-class) that the RoBERTa baseline mis-classifies (5/7
$\to$~7/7 correct), evaluated with 5-fold out-of-fold cross-validation.
